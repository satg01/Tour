...
<html>
<head>
<title>Touur Guide and Planner System</title>
...
<div class="slider-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Touur Guide and Planner System</h1>
	</div>
</div>
<!--- /slider-1 ---->
<!--- privacy ---->
